...
const BrowseRoot = styled('svg')<{ isActive: boolean }>(({ isActive }) => ({
	...
	height: 32,
	animation: isActive
		? `${rotateAnimation} .3s ease-in-out`
		: `${rotateAnimationReverse} .3s ease-in-out`,
	'& g[name="main_parent"]': {
...
export default function Browse({
	...
	return (
		<BrowseRoot isActive={isActive} {...props} viewBox='0 0 24 24'>
			<g name='main_parent'>
				<g name='group'>
					<path
						name='dot'
						fill='currentColor'
						d='M 12 10.9 C 12.61 10.9 13.1 11.39 13.1 12 C 13.1 12.61 12.61 13.1 12 13.1 C 11.39 13.1 10.9 12.61 10.9 12 C 10.9 11.39 11.39 10.9 12 10.9 Z'
					/>
				</g>
