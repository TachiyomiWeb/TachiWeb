...
export default function Palette({
	...
	return (
		<svg width={width} height={height} {...props} viewBox='0 0 24 24'>
			...
			<path
				fill='currentColor'
				d='M6.5,11.5m-1.5,0a1.5,1.5 0,1 1,3 0a1.5,1.5 0,1 1,-3 0'
			/>
			<path
				fill='currentColor'
				d='M9.5,7.5m-1.5,0a1.5,1.5 0,1 1,3 0a1.5,1.5 0,1 1,-3 0'
			/>
			<path
				fill='currentColor'
				d='M14.5,7.5m-1.5,0a1.5,1.5 0,1 1,3 0a1.5,1.5 0,1 1,-3 0'
			/>
			<path
				fill='currentColor'
				d='M17.5,11.5m-1.5,0a1.5,1.5 0,1 1,3 0a1.5,1.5 0,1 1,-3 0'
			/>
		</svg>
	);
}
