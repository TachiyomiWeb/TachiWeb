...
export default function Updates({ isActive, ...props }: { [x: string]: any, isActive: boolean }) {
  return <UpdatesRoot variant={ isActive ? 'filled' : 'outlined' } { ...props } viewBox='0 0 24 24'>
