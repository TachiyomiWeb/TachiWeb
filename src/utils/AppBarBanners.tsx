...
export default function AppBarBanners() {
    ...
    return <React.Fragment>
        { settings.downloaded_only ? <DownloadedOnlyText>{ translation.string["label_downloaded_only"] }</DownloadedOnlyText> : null }
        { settings.incognito ? <IncognitoText>{ translation.string["pref_incognito_mode"] }</IncognitoText> : null }
    </React.Fragment>
}
